...
Public Class FormPembayaran
    ...
    Dim Table_Name As String = "view_jual" 'your table name
    Dim Data As Integer

    Dim LoadImagesStr As Boolean = False
    Dim id_transaksiRam, nama_pelangganRam, nama_paketRam, jumlahRam, hargaRam, totalRam As String
    ...
    Private Sub ShowData()
        ...
        Try
            If LoadImagesStr = False Then
                ...
                MySQLCMD.CommandText = "SELECT id_transaksi, nama_pelanggan, nama_paket, jumlah, harga, total FROM " & Table_Name & " ORDER BY nama_pelanggan"
            ...
            Else
                MySQLCMD.CommandType = CommandType.Text
                MySQLCMD.CommandText = "SELECT Images FROM " & Table_Name & " WHERE id_transaksi LIKE " & id_transaksiRam
                MySQLDA = New MySqlDataAdapter(MySQLCMD.CommandText, Connection)
                DT = New DataTable
                Data = MySQLDA.Fill(DT)
                If Data > 0 Then
    ...
    Private Sub ButtonIDMaker_Click(sender As Object, e As EventArgs) Handles ButtonIDMaker.Click
        ...
        Try
            ...
            MySQLCMD.CommandType = CommandType.Text
            MySQLCMD.CommandText = "SELECT id_transaksi FROM " & Table_Name & " WHERE id_transaksi LIKE " & TextBoxID.Text
            MySQLDA = New MySqlDataAdapter(MySQLCMD.CommandText, Connection)
            DT = New DataTable
            Data = MySQLDA.Fill(DT)
            If Data > 0 Then
    ...
    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        If StatusInput = "Save" Then
            ...
            Try
                ...
                With MySQLCMD
                    .CommandText = "INSERT INTO " & Table_Name & " (id_transaksi, nama_pelanggan, nama_paket, jumlah, harga, total, Images) VALUES (@id_transaksi, @nama_pelanggan, @nama_paket, @jumlah, @harga, @total, @images)"
                    .Connection = Connection
                    .Parameters.AddWithValue("@nama_pelanggan", TextBoxName.Text)
                    .Parameters.AddWithValue("@id_transaksi", TextBoxID.Text)
                    .Parameters.AddWithValue("@nama_paket", TextBoxPrice.Text)
                    .Parameters.AddWithValue("@jumlah", TextBoxAmount.Text)
                    .Parameters.AddWithValue("@harga", TextBoxHarga.Text)
                    .Parameters.AddWithValue("@total", TextBoxTotal.Text)
        ...
        Else
            ...
            If IMG_FileNameInput <> "" Then
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  nama_pelanggan=@nama_pelanggan,nama_paket=@nama_paket,jumlah=@jumlah,harga=@harga,total=@total,Images=@images WHERE id_pelanggan=@id_pelanggan "
                        .Connection = Connection
                        .Parameters.AddWithValue("@nama_pelanggan", TextBoxName.Text)
                        .Parameters.AddWithValue("@id_transaksi", TextBoxID.Text)
                        .Parameters.AddWithValue("@nama_paket", TextBoxPrice.Text)
            ...
            Else
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  nama_pelanggan=@nama_pelanggan,nama_paket=@nama_paket,jumlah=@jumlah,harga=@harga,total=@total WHERE id_transaksi=@id_transaksi "
                        .Connection = Connection
                        .Parameters.AddWithValue("@nama_pelanggan", TextBoxName.Text)
                        .Parameters.AddWithValue("@id_transaksi", TextBoxID.Text)
                        .Parameters.AddWithValue("@nama_paket", TextBoxPrice.Text)
    ...
    Private Sub ButtonEdit_Click(sender As Object, e As EventArgs) Handles ButtonEdit.Click
        If DataGridView1.RowCount = 1 Then
            ...
            TextBoxName.Text = nama_pelangganRam
            TextBoxID.Text = id_transaksiRam
            TextBoxPrice.Text = nama_paketRam
            TextBoxAmount.Text = jumlahRam
            TextBoxHarga.Text = hargaRam
            TextBoxTotal.Text = totalRam
        ...
        Try
            ...
            For Each row As DataGridViewRow In DataGridView1.SelectedRows
                If row.Selected = True Then
                    MySQLCMD.CommandType = CommandType.Text
                    MySQLCMD.CommandText = "DELETE FROM " & Table_Name & " WHERE id_transaksi='" & row.DataBoundItem(1).ToString & "'"
                    MySQLCMD.Connection = Connection
                    MySQLCMD.ExecuteNonQuery()
                End If
            Next
                ...
                If e.Button = MouseButtons.Left Then
                    ...
                    With DataGridView1
                        If e.RowIndex >= 0 Then
                            i = .CurrentRow.Index
                            LoadImagesStr = True
                            id_transaksiRam = .Rows(i).Cells("id_transaksi").Value.ToString
                            nama_pelangganRam = .Rows(i).Cells("nama_pelanggan").Value.ToString
