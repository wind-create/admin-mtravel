...
Public Class FormWisata
    ...
    Dim Table_Name As String = "wisata" 'your table name
    Dim Data As Integer

    Dim LoadImagesStr As Boolean = False
    Dim id_wisataRam, nama_wisataRam, deskripsi_wisataRam As String
    ...
    Private Sub ShowData()
        ...
        Try
            If LoadImagesStr = False Then
                ...
                MySQLCMD.CommandText = "SELECT id_wisata, nama_wisata, deskripsi_wisata FROM " & Table_Name & " ORDER BY nama_wisata"
            ...
            Else
                MySQLCMD.CommandType = CommandType.Text
                MySQLCMD.CommandText = "SELECT Images FROM " & Table_Name & " WHERE id_wisata LIKE " & id_wisataRam
                MySQLDA = New MySqlDataAdapter(MySQLCMD.CommandText, Connection)
                DT = New DataTable
                Data = MySQLDA.Fill(DT)
                If Data > 0 Then
    ...
    Private Sub ButtonIDMaker_Click(sender As Object, e As EventArgs) Handles ButtonIDMaker.Click
        ...
        Try
            ...
            MySQLCMD.CommandType = CommandType.Text
            MySQLCMD.CommandText = "SELECT id_wisata FROM " & Table_Name & " WHERE id_wisata LIKE " & TextBoxID.Text
            MySQLDA = New MySqlDataAdapter(MySQLCMD.CommandText, Connection)
            DT = New DataTable
            Data = MySQLDA.Fill(DT)
            If Data > 0 Then
    ...
    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        If StatusInput = "Save" Then
            ...
            Try
                ...
                With MySQLCMD
                    .CommandText = "INSERT INTO " & Table_Name & " (id_wisata, nama_wisata, deskripsi_wisata, Images) VALUES (@id_wisata, @nama_wisata, @deskripsi_wisata, @images)"
                    .Connection = Connection
                    .Parameters.AddWithValue("@nama_wisata", TextBoxName.Text)
                    .Parameters.AddWithValue("@id_pelanggan", TextBoxID.Text)
                    .Parameters.AddWithValue("@desktipsi_wisata", TextBoxPrice.Text)
        ...
        Else
            ...
            If IMG_FileNameInput <> "" Then
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  nama_wisata=@nama_wisata,alamat_pelanggan=@deskripsi_wisata,Images=@images WHERE id_wisata=@id_wisata "
                        .Connection = Connection
                        .Parameters.AddWithValue("@nama_wisata", TextBoxName.Text)
                        .Parameters.AddWithValue("@id_pelanggan", TextBoxID.Text)
                        .Parameters.AddWithValue("@desktipsi_wisata", TextBoxPrice.Text)
    ...
    Private Sub ButtonEdit_Click(sender As Object, e As EventArgs) Handles ButtonEdit.Click
        If DataGridView1.RowCount = 1 Then
            ...
            TextBoxName.Text = nama_wisataRam
            TextBoxID.Text = id_wisataRam
            TextBoxPrice.Text = deskripsi_wisataRam
        ...
        Try
            ...
            For Each row As DataGridViewRow In DataGridView1.SelectedRows
                If row.Selected = True Then
                    MySQLCMD.CommandType = CommandType.Text
                    MySQLCMD.CommandText = "DELETE FROM " & Table_Name & " WHERE id_wisata='" & row.DataBoundItem(1).ToString & "'"
                    MySQLCMD.Connection = Connection
                    MySQLCMD.ExecuteNonQuery()
                End If
            Next
                ...
                If e.Button = MouseButtons.Left Then
                    ...
                    With DataGridView1
                        If e.RowIndex >= 0 Then
                            i = .CurrentRow.Index
                            LoadImagesStr = True
                            id_wisataRam = .Rows(i).Cells("id_wisata").Value.ToString
                            nama_wisataRam = .Rows(i).Cells("nama_wisata").Value.ToString
                            deskripsi_wisataRam = .Rows(i).Cells("deskripsi_wisata").Value.ToString
                            ShowData()
                        End If
                    End With
                End If
