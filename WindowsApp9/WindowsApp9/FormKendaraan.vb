...
Public Class FormKendaraan
    ...
    Dim Table_Name As String = "kendaraan" 'your table name
    Dim Data As Integer

    Dim LoadImagesStr As Boolean = False
    Dim id_kendaraanRam, nama_kendaraanRam, deskripsi_kendaraanRam As String
    ...
    Private Sub ShowData()
        ...
        Try
            If LoadImagesStr = False Then
                ...
                MySQLCMD.CommandText = "SELECT id_kendaraan, nama_kendaraan, deskripsi_kendaraan FROM " & Table_Name & " ORDER BY nama_kendaraan"
            ...
            Else
                MySQLCMD.CommandType = CommandType.Text
                MySQLCMD.CommandText = "SELECT Images FROM " & Table_Name & " WHERE id_kendaraan LIKE " & id_kendaraanRam
                MySQLDA = New MySqlDataAdapter(MySQLCMD.CommandText, Connection)
                DT = New DataTable
                Data = MySQLDA.Fill(DT)
                If Data > 0 Then
    ...
    Private Sub ButtonIDMaker_Click(sender As Object, e As EventArgs) Handles ButtonIDMaker.Click
        ...
        Try
            ...
            MySQLCMD.CommandType = CommandType.Text
            MySQLCMD.CommandText = "SELECT id_kendaraan FROM " & Table_Name & " WHERE id_kendaraan LIKE " & TextBoxID.Text
            MySQLDA = New MySqlDataAdapter(MySQLCMD.CommandText, Connection)
            DT = New DataTable
            Data = MySQLDA.Fill(DT)
            If Data > 0 Then
    ...
    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        If StatusInput = "Save" Then
            ...
            Try
                ...
                With MySQLCMD
                    .CommandText = "INSERT INTO " & Table_Name & " (id_kendaraan, nama_kendaraan, deskripsi_kendaraan, Images) VALUES (@id_kendaraan, @nama_kendaraan, @deskripsi_kendaraan, @images)"
                    .Connection = Connection
                    .Parameters.AddWithValue("@nama_kendaraan", TextBoxName.Text)
                    .Parameters.AddWithValue("@id_pelanggan", TextBoxID.Text)
                    .Parameters.AddWithValue("@desktipsi_kendaraan", TextBoxPrice.Text)
        ...
        Else
            ...
            If IMG_FileNameInput <> "" Then
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  nama_kendaraan=@nama_kendaraan,alamat_pelanggan=@deskripsi_kendaraan,Images=@images WHERE id_kendaraan=@id_kendaraan "
                        .Connection = Connection
                        .Parameters.AddWithValue("@nama_kendaraan", TextBoxName.Text)
                        .Parameters.AddWithValue("@id_pelanggan", TextBoxID.Text)
                        .Parameters.AddWithValue("@desktipsi_kendaraan", TextBoxPrice.Text)
    ...
    Private Sub ButtonEdit_Click(sender As Object, e As EventArgs) Handles ButtonEdit.Click
        If DataGridView1.RowCount = 1 Then
            ...
            TextBoxName.Text = nama_kendaraanRam
            TextBoxID.Text = id_kendaraanRam
            TextBoxPrice.Text = deskripsi_kendaraanRam
        ...
        Try
            ...
            For Each row As DataGridViewRow In DataGridView1.SelectedRows
                If row.Selected = True Then
                    MySQLCMD.CommandType = CommandType.Text
                    MySQLCMD.CommandText = "DELETE FROM " & Table_Name & " WHERE id_kendaraan='" & row.DataBoundItem(1).ToString & "'"
                    MySQLCMD.Connection = Connection
                    MySQLCMD.ExecuteNonQuery()
                End If
            Next
                ...
                If e.Button = MouseButtons.Left Then
                    ...
                    With DataGridView1
                        If e.RowIndex >= 0 Then
                            ...
                            nama_kendaraanRam = .Rows(i).Cells("nama_kendaraan").Value.ToString
                            deskripsi_kendaraanRam = .Rows(i).Cells("deskripsi_kendaraan").Value.ToString
                            ShowData()
                        End If
                    End With
                End If
