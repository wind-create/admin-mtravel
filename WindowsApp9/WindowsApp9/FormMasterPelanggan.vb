...
Public Class FormMasterPelanggan
    ...
    Private Sub ShowData()
        ...
        Try
            If LoadImagesStr = False Then
                ...
                MySQLCMD.CommandText = "SELECT nama_pelanggan, id_pelanggan, alamat_pelanggan, telp_pelanggan FROM " & Table_Name & " ORDER BY nama_pelanggan"
            ...
            Else
                MySQLCMD.CommandType = CommandType.Text
                MySQLCMD.CommandText = "SELECT Images FROM " & Table_Name & " WHERE id_pelanggan LIKE " & id_pelangganRam
                MySQLDA = New MySqlDataAdapter(MySQLCMD.CommandText, Connection)
                DT = New DataTable
                Data = MySQLDA.Fill(DT)
                If Data > 0 Then
    ...
    Private Sub ButtonEdit_Click(sender As Object, e As EventArgs) Handles ButtonEdit.Click
        If DataGridView1.RowCount = 1 Then
            ...
            TextBoxID.Text = id_pelangganRam
            TextBoxPrice.Text = alamat_pelangganRam
            TextBoxAmount.Text = telp_pelangganRam
        ...
        Try
            ...
            For Each row As DataGridViewRow In DataGridView1.SelectedRows
                If row.Selected = True Then
                    MySQLCMD.CommandType = CommandType.Text
                    MySQLCMD.CommandText = "DELETE FROM " & Table_Name & " WHERE id_pelanggan='" & row.DataBoundItem(1).ToString & "'"
                    MySQLCMD.Connection = Connection
                    MySQLCMD.ExecuteNonQuery()
                End If
            Next
                ...
                If e.Button = MouseButtons.Left Then
                    ...
                    With DataGridView1
                        If e.RowIndex >= 0 Then
                            ...
                            alamat_pelangganRam = .Rows(i).Cells("alamat_pelanggan").Value.ToString
                            telp_pelangganRam = .Rows(i).Cells("telp_pelanggan").Value.ToString
                            ShowData()
                        End If
                    End With
                End If
